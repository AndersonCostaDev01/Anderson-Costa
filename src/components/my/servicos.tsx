...
function Servicos() {
    return (
        <div className="mt-10 container flex mx-auto p-3 flex-col" id="servicos">
            ...
            <Accordion type="single" collapsible className="bg-[#a66a00] p-2 rounded-2xl">
                <AccordionItem value="item-1" className="px-4 py-2 text-white">
                ...
                <AccordionItem value="item-2" className="px-4 py-2 text-white">
                ...
                <AccordionItem value="item-3" className="px-4 py-2 text-white">
                ...
                <AccordionItem value="item-4" className="px-4 py-2 text-white">
                ...
                <AccordionItem value="item-5" className="px-4 py-2 text-white">
